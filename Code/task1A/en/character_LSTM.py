...
if __name__ == '__main__':
    ...
    parser.add_argument("--embedding", help="The embedding size, default=100", default=50)
...
destination_folder = "Model/"+runmane+"_"+language_name+"_"+str(hidden_size)+"_"+str(embedding_size)+"_"+str(learning_rate)+"_"+str(dropout)
report_address = "Reports/"+runmane+"_"+language_name+"_"+str(hidden_size)+"_"+str(embedding_size)+"_"+str(learning_rate)+"_"+str(dropout)
########################################################################
...
with open(report_address,"a+") as f:
    f.write(runmane+"_"+language_name+"_"+str(hidden_size)+"_"+str(embedding_size)+"_"+str(learning_rate)+"_"+str(dropout)+"\n\n")
